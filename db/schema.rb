...
ActiveRecord::Schema.define(version: 2023_11_26_133121) do
  ...
  create_table "agents", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci", force: :cascade do |t|
    t.string "name"
    t.string "username"
    t.string "password"
    t.integer "phone_no"
